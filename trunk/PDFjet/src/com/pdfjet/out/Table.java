...
public class Table {
    ...
    public List<List<Cell>> tableData = null;

    public int numOfHeaderRows = 0;

    public float x1;

    public float y1;

    public float bottom_margin = 30f;
        ...
        for (int i = 0; i < tableData.size(); i++) {
            ...
            for (int j = 0; j < row.size(); j++) {
                ...
                if (cell.getColSpan() == 1) {
                    ...
                    if (max_col_widths[j] == 0f || cell.getWidth() > max_col_widths[j]) {
                ...
                if (cell.text != null) {
                    ...
                    if (tokens.length == 1) {
                        ...
                        for (int k = 0; k < tokens.length; k++) {
                            ...
                            if (cell.font.stringWidth(sb.toString() + " " + token) > (cell.getWidth() - (cell.left_padding + cell.right_padding))) {

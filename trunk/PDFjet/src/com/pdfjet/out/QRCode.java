...
public class QRCode implements Drawable {
    ...
    public static final int PAD0 = 0xEC;

    public static final int PAD1 = 0x11;

    public Boolean[][] modules;

    public int moduleCount = 33;

    public int errorCorrectLevel = ErrorCorrectLevel.M;
    ...
    private byte[] createData(int errorCorrectLevel) {
        ...
        if (buffer.getLengthInBits() > totalDataCount * 8) {
            throw new IllegalArgumentException("String length overflow. (" + buffer.getLengthInBits() + ">" + totalDataCount * 8 + ")");
        }

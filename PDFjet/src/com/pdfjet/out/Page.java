...
public class Page {
    ...
    public float[] tm = new float[] { 1f, 0f, 0f, 1f };
    ...
    public float[] cropBox = null;

    public float[] bleedBox = null;

    public float[] trimBox = null;

    public float[] artBox = null;

    public float[] pen = { 0f, 0f, 0f };

    public float[] brush = { 0f, 0f, 0f };

    public float pen_width = -1.0f;

    public int line_cap_style = 0;

    public int line_join_style = 0;

    public String linePattern = "[] 0";

    public Font font;

    public List<State> savedStates = new ArrayList<State>();
     ...
     * @param yPosition The vertical position of the destination on
     *            this page.
     */
    ...
    /**
     * Draws a line on the page, using the current color, between the
     ...
     * specified main font and the current brush color. If the main
     * font is missing some glyphs - the fallback font is used. The
     * baseline of the leftmost character is at position (x, y) on the
     * page.
     * 
    ...
    /**
     * Draws the text given by the specified string, using the
     * specified font and the current brush color. The baseline of the
     * leftmost character is at position (x, y) on the page.
     * 
    ...
    /**
     * Sets the color for stroking operations. The pen color is used
     * when drawing lines and splines.
     * 
    ...
    /**
     * Sets the color for brush operations. This is the color used
     * when drawing regular text and filling shapes.
     * 
     * @param r the red component is float value from 0.0 to 1.0.
     * @param g the green component is float value from 0.0 to 1.0.
     * @param b the blue component is float value from 0.0 to 1.0.
     ...
     * Sets the pen color.
     * 
     * @param color the color. See the Color class for predefined
     *            values or define your own using 0x00RRGGBB packed
     *            integers.
     * @throws IOException
     */
    ...
    /**
     * Sets the line width to the default. The default is the finest
     * line width.
     */
     ...
     * used to stroke paths. It is specified by a dash array and a
     * dash phase. The elements of the dash array are positive numbers
     * that specify the lengths of alternating dashes and gaps. The
     * dash phase specifies the distance into the dash pattern at
     * which to start the dash. The elements of both the dash array
    ...
    /**
     * Sets the pen width that will be used to draw lines and splines
     * on this page.
     * 
     ...
     * 
     * @param style the cap style of the current line. Supported
     *            values: Cap.BUTT, Cap.ROUND and
     *            Cap.PROJECTING_SQUARE
     */
     ...
     * 
     * @param style the line join style code. Supported values:
     *            Join.MITER, Join.ROUND and Join.BEVEL
     */
    ...
    /**
     * Draws a line from the current pen position to the point with
     * coordinates (x, y), using the current pen width and stroke
     * color. Make sure you call strokePath(), closePath() or
     * fillPath() after the last call to this method.
     */
    ...
    /**
     * Draws the outline of the specified rectangle on the page. The
     * left and right edges of the rectangle are at x and x + w. The
     * top and bottom edges are at y and y + h. The rectangle is drawn
    ...
    /**
     * Fills the specified rectangle on the page. The left and right
     * edges of the rectangle are at x and x + w. The top and bottom
     * edges are at y and y + h. The rectangle is drawn using the
     * current pen color.
     * 
     * @param x the x coordinate of the rectangle to be drawn.
     * @param y the y coordinate of the rectangle to be drawn.
    ...
    /**
     * Draws or fills the specified path using the current pen or
     * brush.
     * 
     * @param path the path.
     ...
     * 
     * @param x the x coordinate of the center of the circle to be
     *            drawn.
     * @param y the y coordinate of the center of the circle to be
     *            drawn.
    ...
    /**
     * Draws the specified circle on the page and fills it with the
     * current brush color.
     * 
     * @param x the x coordinate of the center of the circle to be
     *            drawn.
     ...
     *            drawn.
     * @param r the radius of the circle to be drawn.
     * @param operation must be Operation.STROKE, Operation.CLOSE or
     *            Operation.FILL.
     */
     ...
     * 
     * @param x the x coordinate of the center of the ellipse to be
     *            drawn.
     * @param y the y coordinate of the center of the ellipse to be
     *            drawn.
    ...
    /**
     * Draws an ellipse on the page and fills it using the current
     * brush color.
     * 
     * @param x the x coordinate of the center of the ellipse to be
     *            drawn.
     ...
     * closePath or strokePath method after the last bezierCurveTo
     * call.
     * <p>
    ...
    /**
     * Sets the start of text block. Please see Example_32. This
     * method must have matching call to setTextEnd().
     */
    ...
    /**
     * Prints a line of text and moves to the next line. Please see
     * Example_32.
     */
    ...
    /**
     * Sets the page CropBox. See page 77 of the PDF32000_2008.pdf
     * specification.
     * 
     * @param upperLeftX the top left X coordinate of the CropBox.
     * @param upperLeftY the top left Y coordinate of the CropBox.
     * @param lowerRightX the bottom right X coordinate of the
     *            CropBox.
     * @param lowerRightY the bottom right Y coordinate of the
     *            CropBox.
     */
    ...
    /**
     * Sets the page BleedBox. See page 77 of the PDF32000_2008.pdf
     * specification.
     * 
    ...
    /**
     * Sets the page TrimBox. See page 77 of the PDF32000_2008.pdf
     * specification.
     * 
    ...
    /**
     * Sets the page ArtBox. See page 77 of the PDF32000_2008.pdf
     * specification.
     * 
    ...
    private void printBuffer(StringBuilder buf1, Map<String, Integer> colors) throws Exception {
